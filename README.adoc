...
1. Browse to the collection with your browser and log in (if the collection is private).
...
4. The other data can be found at the "network" tab (maybe requires to refresh the page)
